  ...
  return (
    <div>
      <div className="flex items-center gap-x-2">
        <div className="flex h-10 min-w-10 bg-primary border cursor-pointer rounded-full items-center justify-center">
        ...
        <div>
          ...
          <p className="font-semibold capitalize text-sm flex-1">{author}</p>

...
const Searchbar = () => {
  ...
  return (
    ...
    >
      ...
      <SheetContent
        side="top"
        className="absolute inset-0 max-h-[50vh] bg-popover flex flex-col items-center justify-center  py-20 px-10 "
      >
        <div className="flex flex-col  md:w-2/5 items-center">
          <SheetHeader>
            ...
            <SheetDescription className="text-center py-2">
              Readora is loaded with all types of books from various authors and
              publishers with upto date editions
            </SheetDescription>
          </SheetHeader>
